...
def evolve_solution(game_name, action_space_size, pop_size=1000+1, archive_p=0.1, archive_dump=None, n_generations=5,
                    ...
                    improvement_cutoff=5, starting_gen=0):
    ...
    for gen in range(starting_gen, n_generations):
...
evolve_solution(game_name, action_space_size, pop_size=1000+1, archive_p=0.01, archive_dump=None,
                training_episodes=[0], T=20, n_generations=1000, improvement_cutoff=25, archive=None, starting_gen=0,
                training_frames=20000, validation_frames=20000, validation_episodes=list(range(1,31)), population=None)
