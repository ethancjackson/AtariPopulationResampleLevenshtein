...
action_space_size = env.action_space.n
env.close()
population, gen = load_population('./Assault-GameScore/population-Assault-GameScore-939.pkl')
evolve_solution(game_name, action_space_size, pop_size=1000+1, starting_generation=939,
                training_episodes=[0], T=20, population=population,
